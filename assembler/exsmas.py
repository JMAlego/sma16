...
The extended SMA16 assembler provides a more fully featured assembly language for the SMA16
virtual architecture. Common instructions such as `subtract` and `bitwise or` are provided.
"""
...
def main() -> int:
    ...
    argument_parser = ArgumentParser(description=__doc__, add_help=True)
    argument_parser.add_argument(
        "-v",
        "--version",
        action='version',
        version="Extended SMA16 Assembler [v{version}] by {author}".format(
